...
urlpatterns = [
    ...
    path('home/',user_views.userHomeView,name="userhome"),
    path('staffhome/',user_views.staffHomeView,name="staffhome"),
    path('register/',user_views.userRegisterView,name="userregister"),
